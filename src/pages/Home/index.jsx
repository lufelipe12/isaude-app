  ...
  return (
    <Container>
      ...
      <Curiosidades img={importanceImg}>
        A vacinação é uma forma de salvar vidas! Uma vez expostos a uma, ou mais
        doses de uma vacina, normalmente permanecemos protegidos contra uma
        doença por anos, décadas ou mesmo por todaa vida. É isso que torna as
        vacinas tão eficazes. Ao invés de tratar uma doença depois que ela
